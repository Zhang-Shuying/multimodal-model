...
vad = pd.read_csv('D:/data/vad.csv')
...
#load model
model = load_model('D:/data/muti-pub1.h5')
...
df_train = pd.read_csv('D:/data/train-AD.csv')
...
for P in [0.001,0.01,0.1,1,5,10]:
    for I in [0.3,0.5,0.7,0.9,1,1.2]:
        df_train = pd.read_csv('D:/data/train-AD.csv')
        df_vad = pd.read_csv('D:/data/vad_data_filtered.csv')
